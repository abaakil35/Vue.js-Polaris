<template>
  ...
  >
    <div :style="allContentStyle">
      ...
      <div>
        <h3
          v-if="!containerStyle?.hideLabels"
        ...
        <form class="form-fields">
          <div :style="formFieldsStyle">
            <transition-group name="block-fade-move" tag="div">
              <div
...
const allContentStyle = computed(() => {
  const s = props.containerStyle || {};
  return {
    fontSize: s.fontSize ? s.fontSize + "px" : undefined,
    color: s.textColor,
...
const containerCustomStyle = computed(() => {
  const s = props.containerStyle || {};
  return {
    ...
    border:
      s.borderWidth > 0
        ...
        : undefined,
    boxShadow: s.shadow
      ? `0 2px ${s.shadow * 2}px rgba(0,0,0,0.10)`
      : undefined,
    direction: s.rtlSupport ? "rtl" : "ltr",
  };
});

const formFieldsStyle = computed(() => {
  const s = props.containerStyle || {};
  return {
